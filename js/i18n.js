...
(function () {
  ...
  const T = {
    ...
    zh: {
      // Nav
      nav_treatments:'疗程',
      nav_head_eye:'头眼舒缓SPA',
      nav_facial:'桃花面部SPA', nav_facial_hydrate:'柔润焕肤补水',
      ...
      // Footer
      ft_tagline:'深耕新加坡逾10年，专注面部与全身SPA护理。',
      ...
      t1_h:'头眼舒缓SPA', t1_p:'专业头部护理与眼部舒缓疗程，平衡身心，焕活肌肤，重拾最佳状态。', t1_a:'探索',
      t2_h:'桃花面部SPA', t2_p:'温和面部护理，包括柔润焕肤、润养保湿、柔顺肌理、深层锁水和天然舒缓疗程。', t2_a:'探索',
  ...
  const PAGES = {
    ...
    'treatments/head-eye-spa': {
      '.page-hero h1':                      [['头眼舒缓养护SPA']],
      '.page-hero__inner > p:not(.section__tag)': [['专业头部护理与眼部舒缓疗程的深度修复SPA体验。平衡身体，焕活感官，重新找回最佳的自我。']],
      '.breadcrumb a':                      [['首页']],
      '.breadcrumb > span:nth-child(3)':    [['疗程']],
      '.breadcrumb > span:nth-child(5)':    [['头眼舒缓养护SPA']],
      ...
      '.intro-text p:not(.section__tag)':   [['现代生活对头部和眼睛造成巨大压力。长时间盯着屏幕、精神压力、不良姿势和睡眠不足，都会在头皮、颈部和眼部积累成慢性紧张——让您即使休息后仍感到疲惫、思维模糊、难以恢复精力。'],['我们的头眼舒缓SPA专为从根本上解决这一问题而设计。通过热油头皮按摩、穴位按压和专业眼部护理的组合，疗程能够消除积累的紧张感，改善头皮和面部的血液循环，并平静神经系统——带来远超疗程本身的深度放松感受。'],['定期疗程有助于调节睡眠质量、减少与压力相关的头痛、缓解眼部疲劳和干涩，并恢复头皮和秀发的自然活力。这是专为在日常生活中承受脑力压力的人士设计的全面头眼养护仪式。']],
      ...
      '.benefit-card p':                    [['专业按摩与穴位按压能消除头皮、太阳穴和颅底积聚的紧绷感。许多客户在仅一次疗程后，就能明显感受到面部表情和下颌紧张的舒缓。'],['暖眼敷包与眼眶周围的轻柔穴位按压促进血液循环，缓解干涩，并消除因长时间盯屏幕或睡眠不足而产生的沉重、疲劳感。'],['促进头皮血液流动，滋养毛囊，平衡油脂分泌，为持续更健康、更有弹性的秀发创造有利条件。'],['专业头部按摩引发的副交感神经系统反应，能产生冥想般的平静状态——降低皮质醇，减缓心率，让繁忙过载的思维得以平息。'],['定期预约头眼舒缓SPA的客户普遍反映入睡更容易、醒来后更加精神——这是因为神经系统紧张在傍晚得到了有效释放。'],['放松效果在首次疗程中即可见。肌肤显得更加平静，眉头舒展，面容呈现出休息后的焕然一新，周围的人都能感受到变化。']],
      ...
      '.faq-q':                             [['头眼舒缓SPA应该多久来一次？'],['这个疗程适合头皮敏感的人吗？'],['这对慢性头痛有帮助吗？'],['每次疗程需要多长时间？']],
      '.faq-a p':                           [['用于日常保健和压力管理，每两到三周一次最为理想。如果您正经历急性紧张、频繁头痛或明显眼部疲劳，第一个月内每周疗程能带来更快、更持久的缓解效果。您的治疗师将根据您的生活方式和目标推荐合适的疗程安排。'],['是的。我们会根据您的头皮类型和敏感程度选择相应的油和产品。按压力道始终按照您的舒适程度调整。患有头皮银屑病或湿疹等情况的客户，请事先告知治疗师，以便调整治疗方案。'],['许多客户通过定期头部SPA疗程，明显缓解了紧张性头痛。按摩和穴位按压能够针对紧张性头痛常见的肌肉和筋膜紧张。但如果您的头痛频繁或严重，我们建议您在接受SPA疗程的同时，向医疗专业人士咨询。'],['标准头眼舒缓SPA疗程为60分钟。希望额外加入颈肩护理或全面部放松序列的客户，可预约90分钟延长版疗程。疗程须提前预约——请提前预定您喜欢的时间。']],
      '.page-cta h2':                       [['准备好放下一切，让自己真正休息一下？']],
      '.page-cta p':                        [['立即预约您的头眼舒缓SPA疗程。带着紧绷而来，焕然一新而归——须提前预约。']],
    },

    'treatments/facial-spa': {
      '.page-hero h1':                      [['桃花焕颜面部养护SPA']],
      '.page-hero__inner > p:not(.section__tag)': [['温和的面部养护疗程，结合肌肤亮白、深层补水、柔顺肌理与天然舒缓——专为日常肌肤护理与持久光彩而设计。']],
      '.breadcrumb a':                      [['首页']],
      '.breadcrumb > span:nth-child(3)':    [['疗程']],
      '.breadcrumb > span:nth-child(5)':    [['桃花焕颜面部SPA']],
      '.page-hero__btns a':                 [['免费预约咨询'],['了解疗程流程']],
      '.page-cta__btns a':                  [['立即预约'],['探索所有疗程']],
      '.section__tag':                      [['疗程'],['关于疗程'],['疗程效益'],['疗程流程'],['常见问题']],
      '.intro-text h2':                     [['滋养与放松并重的面部护理']],
      '.intro-text p:not(.section__tag)':   [['我们的面部SPA建立在一个简单的理念之上——当肌肤得到温和、持续且用心的护理时，其反应最为出色。这个疗程不采用激进的换肤或高强度干预，而是顺应肌肤的自然节律，从内而外恢复清晰度、柔软度和自然光泽。'],['桃花焕颜面部护理汲取植物护肤传统精华——结合亮肤活性植物精华、深层补水技术、温和调理按摩及定制面膜方案。效果是真正健康的肌肤：柔软、匀称、平静且充满光彩。'],['适合所有肤质——尤其适合暗沉、不均匀或敏感肌肤，希望在无不适或停工期的情况下看到明显改善的人士。定期疗程可逐步改善肌肤纹理、补水储备，以及肌肤抵御环境压力的能力。']],
      ...
      '.benefit-card p':                    [['植物亮肤活性成分温和抑制黑色素过度生成，减少肤色不均和色斑的外观，经持续疗程后呈现更清透、更光泽的肤色。'],['分层补水技术——包括面膜、按摩和精华导入——在肌肤多个深度补充水分，产生仅靠外用产品无法实现的持久饱满与柔嫩感。'],['温和去角质和调理按摩逐步改善肌肤纹理，软化粗糙区域，抚平不均匀的表面瑕疵，而不损伤肌肤屏障。'],['面部按摩环节激活面部穴位和淋巴通路——消除浮肿，缓解下颌紧张，让面部在每次疗程后看起来明显更放松、更有轮廓感。'],['定期疗程能强化肌肤的水分屏障，提高其应对环境压力——紫外线、污染和空调——的能力，让肌肤日常保持更平静、更均衡的状态。'],['面部SPA完全无创，无泛红、脱皮或恢复期。您可以立即恢复日常活动——通常离开时的状态比来时更好看。']],
      ...
      '.faq-q':                             [['面部SPA应该多久做一次？'],['这适合敏感肌肤吗？'],['第一次疗程后就能看到效果吗？'],['有停工期吗？']],
      '.faq-a p':                           [['为达到最佳效果，我们建议每两到四周进行一次疗程。肌肤的自然更新周期约为28天，将疗程与这一节律结合，可让每次护理在上次基础上持续累积。大多数客户在肌肤达到健康、水润的基础水平后，每月维护一次即可。'],['是的——面部SPA专为敏感肌肤设计，足够温和。所有使用的产品均以低刺激性为标准精心筛选，治疗师会根据您肌肤的反应调整方案。我们避免使用强效去角质产品、香料以及任何可能损害肌肤屏障的技术。'],['大多数客户在首次疗程后即刻感受到亮白度、光滑度和水润感的明显改善。肌肤看起来更洁净、更均匀、更有光泽。色素、纹理和肤色的累积改善将随着多次疗程的持续进行而逐步显现。'],['完全没有。面部SPA完全无创，不会引起泛红、脱皮或敏感反应。疗程结束后可立即化妆并恢复所有正常活动。在重要活动或场合前安排此疗程是安全的。']],
      '.page-cta h2':                       [['给您的肌肤应得的呵护']],
      '.page-cta p':                        [['立即预约您的面部SPA疗程，感受持续温和护理的美丽蜕变——须提前预约。']],
    },
